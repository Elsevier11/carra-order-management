...
async function main() {
  ...
  const newOrdiniColumns: Array<{ col: string; ddl: string }> = [
    ...
    { col: 'lavorazione_parziale',     ddl: 'ALTER TABLE ordini ADD COLUMN lavorazione_parziale BOOLEAN NOT NULL DEFAULT FALSE' },
    { col: 'attesa_materiale',         ddl: 'ALTER TABLE ordini ADD COLUMN attesa_materiale BOOLEAN NOT NULL DEFAULT FALSE' },
    { col: 'residui_lavorazione_note', ddl: 'ALTER TABLE ordini ADD COLUMN residui_lavorazione_note TEXT' },
